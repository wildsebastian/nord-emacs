...
(let* ((class '((class color) (min-colors 89)))
  (nord0 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#2E3440" nil))
  (nord1 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#3B4252" "black"))
  (nord2 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#434C5E" "#434C5E"))
  (nord3 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#4C566A" "brightblack"))
  (nord4 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#D8DEE9" "#D8DEE9"))
  (nord5 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#E5E9F0" "white"))
  (nord6 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#ECEFF4" "brightwhite"))
  (nord7 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#8FBCBB" "cyan"))
  (nord8 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#88C0D0" "brightcyan"))
  (nord9 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#81A1C1" "blue"))
  (nord10 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#5E81AC" "brightblue"))
  (nord11 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#BF616A" "red"))
  (nord12 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#D08770" "brightyellow"))
  (nord13 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#EBCB8B" "yellow"))
  (nord14 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#A3BE8C" "green"))
  (nord15 (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) "#B48EAD" "magenta"))
  (nord-annotation nord12)
  (nord-attribute nord7)
  (nord-class nord7)
  (nord-comment (if (or (and (daemonp) (nord-display-truecolor-or-graphic-p)) (nord-display-truecolor-or-graphic-p)) (nord-theme--brightened-comment-color nord-comment-brightness) "brightblack"))
  (nord-escape nord12)
  (nord-method nord8)
  (nord-keyword nord9)
  (nord-numeric nord15)
